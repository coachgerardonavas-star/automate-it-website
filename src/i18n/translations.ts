      ...
      privacy: {
        ...
        sections: [
          ...
          },
          {
            ...
            body: "Usar IA como parte de nuestros servicios no significa que toda la información que nos das pase por un sistema de IA. Estos son los casos en que sí ocurre: para preparar tu diagnóstico, tu consultoría o una propuesta, podemos usar herramientas de inteligencia artificial de terceros (por ejemplo, Claude, de Anthropic) para analizar las respuestas y la información sobre tu negocio que nos diste. Hoy no hacemos llamadas automáticas con asistentes de voz de IA ni respondemos WhatsApp con IA: esas conversaciones las atiende una persona. Hasta el 26 de septiembre de 2026, quien completaba el diagnóstico y dejaba su teléfono podía recibir una llamada de un asistente de voz con IA operado por Retell AI, que grababa la llamada y guardaba la transcripción; de esas llamadas conservamos en nuestro CRM un resumen y una evaluación de interés. Si quieres que eliminemos esa información, escríbenos.",
          },
          {
            heading: "Con quién compartimos tu información",
            body: "No vendemos ni alquilamos tu información personal. Para operar, tu información pasa por proveedores que la procesan por encargo nuestro: Cloudflare (hosting del sitio y procesamiento de formularios), HubSpot (CRM donde guardamos contactos y notas), Make (automatización que conecta esos sistemas), Telegram (avisos internos al equipo cuando llega una solicitud), Google (correo electrónico y Google Analytics), Anthropic (herramientas de IA para analizar información), Retell AI (llamadas con asistente de voz hechas hasta el 26 de septiembre de 2026), Meta/WhatsApp (mensajes que nos envías por WhatsApp), Stripe (pagos) y Supabase (portal privado de clientes). Cada proveedor trata la información bajo sus propios términos.",
          },
          {
      ...
      privacy: {
        ...
        sections: [
          ...
          },
          {
            ...
            body: "Using AI as part of our services does not mean that all the information you give us goes through an AI system. These are the cases where it does: to prepare your diagnostic, consultation, or proposal, we may use third-party artificial intelligence tools (for example, Claude, by Anthropic) to analyze your answers and the information about your business that you gave us. We do not currently make automated calls with AI voice assistants or answer WhatsApp with AI: a person handles those conversations. Until September 26, 2026, people who completed the diagnostic and left a phone number could receive a call from an AI voice assistant run by Retell AI, which recorded the call and kept the transcript; from those calls we keep a summary and an interest assessment in our CRM. If you want us to delete that information, email us.",
          },
          {
            heading: "Who we share your information with",
            body: "We do not sell or rent your personal information. To operate, your information passes through providers that process it on our behalf: Cloudflare (site hosting and form processing), HubSpot (the CRM where we keep contacts and notes), Make (automation that connects those systems), Telegram (internal alerts to our team when a request arrives), Google (email and Google Analytics), Anthropic (AI tools used to analyze information), Retell AI (AI voice assistant calls made until September 26, 2026), Meta/WhatsApp (messages you send us on WhatsApp), Stripe (payments), and Supabase (private client portal). Each provider handles the information under its own terms.",
          },
          {
